...
def upgrade() -> None:
    ...
    sa.Column('project_type', sa.Enum('DYNAMIC', 'CINEMATIC', 'DOCUMENTARY', 'SOCIAL', 'CUSTOM', name='projecttype', native_enum=False), nullable=True),
    sa.Column('status', sa.Enum('DRAFT', 'PROCESSING', 'COMPLETED', 'FAILED', 'EXPORTED', name='projectstatus', native_enum=False), nullable=True),
    ...
    sa.Column('codec', sa.Enum('H264', 'H265', 'VP9', 'AV1', name='videocodec', native_enum=False), nullable=False),
    sa.Column('bitrate', sa.Integer(), nullable=True),
    sa.Column('status', sa.Enum('UPLOADING', 'UPLOADED', 'PROCESSING', 'ANALYZED', 'FAILED', name='videostatus', native_enum=False), nullable=True),
    ...
    sa.Column('status', sa.Enum('DRAFT', 'APPROVED', 'PROCESSING', 'COMPLETED', 'FAILED', name='cuttingplanstatus', native_enum=False), nullable=True),
    sa.Column('processing_progress', sa.Float(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('output_format', sa.Enum('MP4', 'MOV', 'WEBM', 'AVI', name='exportformat', native_enum=False), nullable=False),
    sa.Column('resolution', sa.String(length=20), nullable=False),
    sa.Column('quality', sa.Enum('LOW', 'MEDIUM', 'HIGH', 'ULTRA', name='exportquality', native_enum=False), nullable=False),
    ...
    sa.Column('status', sa.Enum('QUEUED', 'PROCESSING', 'COMPLETED', 'FAILED', 'CANCELLED', name='exportstatus', native_enum=False), nullable=True),
    ...
    sa.ForeignKeyConstraint(['cutting_plan_id'], ['cutting_plans.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
